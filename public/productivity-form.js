// Immediately Invoked Function Expression (IIFE) to ensure proper initialization
(async function() {
    // Define your Supabase URL and Key
    const SUPABASE_URL = 'https://dwcbvbpwkfmydeucsydj.supabase.co';
    const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR3Y2J2YnB3a2ZteWRldWNzeWRqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjI4NTQ2NTMsImV4cCI6MjAzODQzMDY1M30.g688zmPnGmwu9oBt7YrfUmtivDohDyiEYPQP-lz16GI'; // Replace with your actual Supabase key
    ...
    // Function to fetch regions based on department
